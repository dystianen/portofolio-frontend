  ...
  return (
    <div className='relative -mt-8 md:mt-0'>
      ...
      <p data-aos='fade-up' className='text-base text-justify'>
        Hi, I&#39;m a frontend developer with more than 4 years experience in this industry. I am very passionate and enthusiastic in creating attractive and easy-to-use user interfaces. I have experience in several frameworks such as React,
